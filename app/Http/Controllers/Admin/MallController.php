...
{
    protected $model = '';
    protected $path  = 'malls';
    protected $route = 'malls';
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($data['icon'])) {
            ...
            \Storage::put('public/malls/'. $filenametostore, fopen($data['icon'], 'r+'));
            \Storage::put('public/malls/thumbnail/'. $filenametostore, fopen($data['icon'], 'r+'));

            //Resize image here
            $thumbnailpath = public_path('storage/malls/thumbnail/'.$filenametostore);
