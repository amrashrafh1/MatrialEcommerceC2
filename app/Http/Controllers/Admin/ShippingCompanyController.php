...
{
    protected $model = '';
    protected $path  = 'shippingCompanies';
    protected $route = 'shippingcompanies';
    ...
    {
        return $datatable->render('Admin.'.$this->path.'.index', ['title' => trans('admin.shippingCompanies') . ' Table']);
    }
    ...
    public function store(Request $request)
    {
        ...
        if(!empty($data['icon'])) {
            ...
            \Storage::put('public/'.$this->path.'/'. $filenametostore, fopen($data['icon'], 'r+'));
            \Storage::put('public/'.$this->path.'/thumbnail/'. $filenametostore, fopen($data['icon'], 'r+'));
            ...
            $data['icon'] = 'public/'.$this->path.'/'.$filenametostore;
        }
