...
class DiscountDataTable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.discounts.buttons.actions')
            ->addColumn('checkbox', 'Admin.discounts.buttons.checkbox')
            ->addColumn('product', 'Admin.discounts.buttons.product')
            ->rawColumns(['checkbox','show_action','product','actions','date']);
    }
	...
	public function query()
    {
	    ...
	    protected function getColumns()
	    {
            ...
            [
                'name'  => 'max_quantity',
                'data'  => 'max_quantity',
                'title' => trans('admin.max_quantity'),
            ],
            [
                'name'  => 'product',
                'data'  => 'product',
