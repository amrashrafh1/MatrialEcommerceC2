...
class TradmarkDataTable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.tradmarks.buttons.actions')
            ->addColumn('logo', 'Admin.tradmarks.buttons.logo')
            ->addColumn('name', 'Admin.tradmarks.buttons.name')
            ->addColumn('checkbox', 'Admin.tradmarks.buttons.checkbox')
            ->rawColumns(['checkbox','show_action','actions','logo','date']);
    }

	public function query()
    {
        return Tradmark::query();
