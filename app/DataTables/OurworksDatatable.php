...
class OurworksDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
        ->addColumn('actions', 'Admin.cms.ourworks.buttons.actions')
        ->addColumn('checkbox', 'Admin.cms.ourworks.buttons.checkbox')
            ->addColumn('image', 'Admin.cms.ourworks.buttons.image')
            ->rawColumns(['checkbox','actions','date', 'image']);
    }

    public function query()
    {
        return Ourwork::query();
    }
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        ...
                        'action'    => 'function(){
                        	window.location.href =  "'.\route('ourworks.create').'";
                        }',
                    ],
                ],
