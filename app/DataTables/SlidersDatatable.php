...
class SlidersDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.cms.sliders.buttons.actions')
            ->addColumn('checkbox', 'Admin.cms.sliders.buttons.checkbox')
            ->addColumn('image', 'Admin.cms.sliders.buttons.image')
