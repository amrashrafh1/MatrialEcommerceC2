...
class AdzDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.adzs.buttons.actions')
            ->addColumn('checkbox', 'Admin.adzs.buttons.checkbox')
            ->addColumn('image', 'Admin.adzs.buttons.image')
            ...
            ->parameters([
                ...
                'buttons'    => [
                    ...
                    [
                        ...
                        'action'    => 'function(){
                        	window.location.href =  "'.\route('adzs.create').'";
                        }',
                    ],
                ],
