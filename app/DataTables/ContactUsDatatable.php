...
class ContactUsDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        ...
        ->addColumn('actions', 'Admin.cms.contact_us.buttons.actions')
        ->addColumn('checkbox', 'Admin.cms.contact_us.buttons.checkbox')
            ...
            ->parameters([
                ...
                'buttons' => [
                    ...
                    [
                        ...
                        'action'    => 'function(){
                        	window.location.href =  "'.\route('contact_us.create').'";
                        }',
                    ],
                ],
