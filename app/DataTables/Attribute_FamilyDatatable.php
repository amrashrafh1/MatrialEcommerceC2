...
class Attribute_FamilyDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.attribute_families.buttons.actions')
            ->addColumn('checkbox', 'Admin.attribute_families.buttons.checkbox')
            ->addColumn('name', 'Admin.attribute_families.buttons.name')
            ->addColumn('attribute', 'Admin.attribute_families.buttons.attribute')
            ->rawColumns(['checkbox','attribute','show_action','parent','actions','user','date']);
    }

	public function query()
    {
        return  Attribute_Family::query();
    }
	    ...
	    protected function getColumns()
	    {
            ...
            [
                ...
                'name'=>'attribute',
                'data'=>'attribute',
                'title'=>trans('admin.Add_Attributes'),
           ],
 [
	                'name' => 'actions',
	                'data' => 'actions',
	    ...
	    {
	        return 'attribute_families_' . time();
	    }
