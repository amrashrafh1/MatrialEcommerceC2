...
class TestimonailsDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.cms.testimonials.buttons.actions')
            ->addColumn('checkbox', 'Admin.cms.testimonials.buttons.checkbox')
            ->addColumn('image', 'Admin.cms.testimonials.buttons.image')
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'  => 'project_type',
                'data'  => 'project_type',
                'title' => trans('admin.project_type')
            ],
            [
                'name'       => 'actions',
                'data'       => 'actions',
