...
class CityDataTable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ...
            ->addColumn('country_id', 'Admin.cities.buttons.country_id')
            ->addColumn('checkbox', 'Admin.cities.buttons.checkbox')
            ->addColumn('city_name', 'Admin.cities.buttons.city_name')
            ->rawColumns(['checkbox','show_action','actions','country_id','date']);
    }
