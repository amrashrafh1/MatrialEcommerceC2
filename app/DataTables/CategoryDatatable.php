...
class CategoryDataTable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ...
            ->addColumn('checkbox', 'Admin.categories.buttons.checkbox')
            //->addColumn('name', 'Admin.categories.buttons.name')
            ->addColumn('slug', 'Admin.categories.buttons.slug')
            ->addColumn('parent', 'Admin.categories.buttons.parent')
            ->rawColumns(['checkbox','show_action','parent','actions','date']);
    }

	public function query(Category $model)
    {
        return $model->newQuery()->select('name->en as ss','slug','id','parent_id');
    }
