...
class PostDataTable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.posts.buttons.actions')
            ->addColumn('image', 'Admin.posts.buttons.image')
            ->addColumn('title', 'Admin.posts.buttons.name')
            ->addColumn('checkbox', 'Admin.posts.buttons.checkbox')
            ->addColumn('slug', 'Admin.posts.buttons.slug')
            ->rawColumns(['checkbox','show_action','actions','image','date']);
    }
