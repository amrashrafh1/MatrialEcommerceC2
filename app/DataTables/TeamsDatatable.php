...
class TeamsDatatable extends DataTable
{
    public function dataTable(DataTables $dataTables, $query)
    {
        return datatables($query)
            ->addColumn('actions', 'Admin.cms.teams.buttons.actions')
            ->addColumn('checkbox', 'Admin.cms.teams.buttons.checkbox')
            ->addColumn('image', 'Admin.cms.teams.buttons.image')
            ->rawColumns(['checkbox','actions','show_action','image','date']);
    }
    ...
    protected function getColumns()
    {
        return [
            ...
            [
                'name'=>'job_title',
                'data'=>'job_title',
                'title'=> trans('admin.job_title')
            ],
            [
                'name'=>'linkdin_account',
                'data'=>'linkdin_account',
                'title'=> trans('admin.linkdin_account')
            ],
            [
                'name'       => 'actions',
                'data'       => 'actions',
