<template>
    ...
    <form :action="route" method="post">
        ...
        <div class="md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
            <!-- Accordion card -->
            <div class="card" v-for="(input, index) in inputs">
                <div class="col-md-12">
                <form @submit.prevent="deleteVariation(index)" class="pull-right">
                    <input type="hidden" name="id" :value="variations[index]['id']">
                    <button class="btn btn-danger"><i class="fa fa-times"></i></button>
                </form>
                </div>
                <!-- Card header -->
                <input type="hidden" name="variation_id[]" :value="variations[index]['id']">
                <div class="card-header" role="tab" id="headingTwo2">
                    <a class="collapsed" data-toggle="collapse" data-parent="#accordionEx" :href="'#collapseTwo2'+index"
                       aria-expanded="false" :aria-controls="'collapseTwo2'+index">
                        <h5 class="mb-0">
                            <div class="row">
                                <div class="form-group col-3" v-for="(fam, indx) in family" :key="fam.id">
                                    <h3>{{fam.name[locale]}}</h3>
                                    <select-variation :item="list[index][indx]" :locale="locale" :fam="fam" :attributes="attributes" :translation="translations[locale+'.admin']['empty']"></select-variation>
                                </div>
                            </div>
                ...
                <div :id="'collapseTwo2'+index" class="collapse" role="tabpanel" aria-labelledby="headingTwo2"
                    ...
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="text" name="sku[]" :value="variations[index]['sku']" :placeholder="translations[locale+ '.admin']['sku']">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="number" step="00.01" placeholder="0.00"
                                       name="sale_price[]" :value="variations[index]['sale_price']">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" type="number" step="00.01" placeholder="0.00"
                                       name="purchase_price[]" :value="variations[index]['purchase_price']">
                            </div>
                        </div>
                        <div class="form-group row">
                            <div class="col-md-4">
                            ...
                            <div class="col-md-8">
                                <input class="form-control" name="stock[]" type="number"
                                       :placeholder="translations[locale+ '.admin']['stock']" :value="variations[index]['stock']">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="in_stock[]">
                                    <option value="in_stock" :selected="variations[index]['in_stock'] == 'in_stock'">{{translations[locale+ '.admin']['in_stock']}}</option>
                                    <option value="out_stock" :selected="variations[index]['in_stock'] == 'out_stock'">{{translations[locale+ '.admin']['out_stock']}}</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-md-8">
                                <select class="form-control" name="visible[]">
                                    <option value="visible" :selected="variations[index]['visible'] == 'visible'">{{translations[locale+ '.admin']['visible']}}</option>
                                    <option value="hidden"  :selected="variations[index]['visible'] == 'hidden'">{{translations[locale+ '.admin']['hidden']}}</option>
                                </select> </div>
                        </div>
            ...
            <!-- Accordion card -->
            <!-- Accordion card -->
            <div class="card" v-for="(newinput, index) in newInputs" :key="index + variations.length">

                <!-- Card header -->
                <div class="card-header" role="tab" id="headingOne1">
                    <a data-toggle="collapse" data-parent="#accordionEx" :href="'#collapseOne'+index + variations.length" aria-expanded="true"
                ...
                <!-- Card body -->
                <div :id="'collapseOne'+index + variations.length" class="collapse" role="tabpanel" aria-labelledby="headingOne1"
                     data-parent="#accordionEx">
                    <div class="card-body">
                        <div class="form-group row">
                            <div class="col-md-4">
...
<script>
    ...
    export default {
        ...
        props: ['locale', 'attributes', 'family', 'route', 'list', 'variations', 'delete'],
        data() {
            return {
                inputs: [],
                newInputs:[],
        ...
        methods: {
            ...
            deleteVariation (index) {
                console.log(index);
                var thi = this;
                axios.delete(this.delete, {params: {'id': thi.variations[index]['id']}})
                .then((response) => {
