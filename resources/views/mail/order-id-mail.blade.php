                                  ...
                                  <tr>
                                    <td role="modules-container"
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                        role="module" data-type="columns" style="padding:30px 20px 40px 30px;"
                                        bgcolor="#77dedb">
                                        <tbody>
                                                        ...
                                                        <tbody>
                                                          <tr>
                                                            <td
                                                              ...
                                                              <div>
                                                                  <div style="font-family: inherit; text-align: inherit">
                                                                <span style="font-size: 24px">Your order ID : {{$orderId}}</span><br/>
                                                                  </div>
                                                                <div style="font-family: inherit; text-align: inherit">
                                                                  <span style="font-size: 24px">Now you can relax. We're
                                                                    workin on</span></div>
                                                                <div style="font-family: inherit; text-align: inherit">
                                                                  <span style="font-size: 24px">getting your order to you
                                                                    ASAP!</span>
                                                              ...
                                                              <table border="0" cellpadding="0" cellspacing="0"
                                                                ...
                                                                <tbody>
                                                                  ...
                                                                  <a href="{{route('track-your-order')}}"
                                                                        ...
                                                                        target="_blank">Follow Your Delivery</a>
                                                                    </td>
                                                                  </tr>
                                                                </tbody>
                                                              </table>
                                      ...
                                      <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%"
                                        role="module" data-type="columns" style="padding:0px 20px 0px 20px;"
                                        bgcolor="#0055ff">
                                        <tbody>
                                          <tr role="module-content">
                                            <td height="100%" valign="top">
