...
<![endif]-->
                                                                        ...
                                                                        <td role="modules-container"
                                                                                                                        ...
                                                                                                                        <td style="padding:100px 0px 18px 0px; line-height:36px; text-align:inherit;"
                                                                                                                            ...
                                                                                                                            <div>
                                                                                                                                <div
                                                                                                                                    ...
                                                                                                                                    <span
                                                                                                                                        style="color: #ffffff; font-size: 40px; font-family: inherit">Thank
                                                                                                                                        you
                                                                                                                                        for
                                                                                                                                        your
                                                                                                                                        order!</span>
                                                                                        ...
                                                                                        <td style="padding:30px 20px 18px 30px; line-height:22px; text-align:inherit;"
                                                                                            ...
                                                                                            <div>
                                                                                                <div
                                                                                                    style="font-family: inherit; text-align: inherit">
                                                                                                    <span
                                                                                                        style="color: #0055ff; font-size: 24px">Order
                                                                                                        Summary</span>
                                                                                                </div>
                                                                                                <div></div>
                                                                                            </div>
                                                                            ...
                                                                            <table class="module" role="module"
                                                                                ...
                                                                                <tbody>
                                                                                    <tr>
                                                                                        <div
                                                                                            style="padding:0 20px 0; font-family: inherit; text-align: inherit">
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns"
            style="padding:20px 20px 0px 30px;" bgcolor="#FFFFFF">
            <tbody>
                <tr role="module-content">
                    <td height="100%" valign="top">
                                ...
                                <tr>
                                    <td style="padding:0px;margin:0px;border-spacing:0;">
                                        <table class="wrapper" role="module" data-type="image" border="0"
                                            ...
                                            data-muid="239f10b7-5807-4e0b-8f01-f2b8d25ec9d7">
                                            <tbody>
                                                <tr>
                                                    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                        ...
                                                        <img class="max-width" border="0"
                                                            style="display:block; color:#000000; text-decoration:none; font-family:Helvetica, arial, sans-serif; font-size:16px;"
                                                            width="104" alt="" data-proportionally-constrained="true"
                                                            data-responsive="false"
                                                            src="{{Storage}}"
                                                            height="104">
                                                    </td>
                                                    ...
                                                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                        ...
                                                        <div>
                                                            ...
                                                            <div style="font-family: inherit; text-align: inherit"><span
                                                                    style="color: #0055ff">${{$line->price}} * {{$line->quantity}}&nbsp;</span></div>
                                                            <div></div>
                                                        </div>
                                                    </td>
                                                </tr>
                        ...
                        <table width="137"
                            style="width:137px; border-spacing:0; border-collapse:collapse; margin:0px 0px 0px 0px;"
                            cellpadding="0" cellspacing="0" align="left" border="0" bgcolor="" class="column column-2">
                            <tbody>
                                <tr>
                        ...
                        <table width="137"
                            style="width:137px; border-spacing:0; border-collapse:collapse; margin:0px 0px 0px 0px;"
                            cellpadding="0" cellspacing="0" align="left" border="0" bgcolor="" class="column column-3">
                            <tbody>
                                <tr>
                                    <td style="padding:0px;margin:0px;border-spacing:0;"></td>
                                </tr>
                                                ...
                                                <tr>
                                                    <td style="font-size:6px; line-height:10px; padding:0px 0px 0px 0px;"
                                                        ...
                                                        <img class="max-width" border="0"
                                                            ...
                                                            width="104" alt="" data-proportionally-constrained="true"
                                                            data-responsive="false"
                                                            src="http://cdn.mcauto-images-production.sendgrid.net/954c252fedab403f/fcc12b6b-1d51-4693-8bf6-d7dbbb224010/104x104.png"
                                                            height="104">
                                                    </td>
                                                </tr>
                                            </tbody>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                        ...
                                                        <div>
                                                            <div style="font-family: inherit; text-align: inherit">
                                                                Vietnamese Iced Coffee w/ Boba</div>
                                                            <div style="font-family: inherit; text-align: inherit"><br>
                                                            </div>
                                                            <div style="font-family: inherit; text-align: inherit"><span
                                                                    style="color: #0055ff">$2.49&nbsp;</span></div>
                                                            <div></div>
                                                        </div>
                                                    </td>
                                                </tr>
        ...
        <table class="module" role="module" data-type="divider" border="0" cellpadding="0" cellspacing="0" width="100%"
            style="table-layout: fixed;" data-muid="f7373f10-9ba4-4ca7-9a2e-1a2ba700deb9.1">
            <tbody>
                <tr>
                    <td style="padding:20px 30px 0px 30px;" role="module-content" height="100%" valign="top" bgcolor="">
                        <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" height="3px"
                            style="line-height:3px; font-size:3px;">
                            <tbody>
                                <tr>
        ...
        <table class="module" role="module" data-type="text" border="0" cellpadding="0" cellspacing="0" width="100%"
            style="table-layout: fixed;" data-muid="264ee24b-c2b0-457c-a9c1-d465879f9935.1">
            <tbody>
                <tr>
                    <td style="padding:18px 20px 30px 30px; line-height:22px; text-align:inherit;" height="100%"
                        valign="top" bgcolor="" role="module-content">
                        <div>
                            <div style="font-family: inherit; text-align: inherit">Subtotal - ${{$order->sub_total}}</div>
                            <div style="font-family: inherit; text-align: inherit">Taxes - ${{$tax}}</div>
                            <div style="font-family: inherit; text-align: inherit">Shipping - ${{$shipping}}</div>
                            <div style="font-family: inherit; text-align: inherit">Coupons - ${{$order->coupon}}</div>
                            <div style="font-family: inherit; text-align: inherit"><br>
                                Grand Total&nbsp;</div>
                            <div style="font-family: inherit; text-align: inherit"><br></div>
                            <div style="font-family: inherit; text-align: inherit"><span
                                    style="color: #0055ff; font-size: 32px; font-family: inherit">${{$order->grand_total}}</span></div>
                            <div></div>
                        </div>
                    </td>
                </tr>
        ...
        <table border="0" cellpadding="0" cellspacing="0" align="center" width="100%" role="module" data-type="columns"
            style="padding:0px 20px 0px 20px;" bgcolor="#0055ff">
            <tbody>
                <tr role="module-content">
                    <td height="100%" valign="top">
                                                        ...
                                                        <div>
                                                            <div style="font-family: inherit; text-align: center"><a
                                                                    href="{{route('home')}}"><span
                                                                        style="color: #ffffff">Home</span></a></div>
                                                            <div></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                        ...
                                                        <div>
                                                            <div style="font-family: inherit; text-align: center"><a
                                                                    href="{{route('contact_us')}}"><span style="color: #ffffff">Contact
                                                                        Us</span></a></div>
                                                            <div></div>
                                                        </div>
                                                    </td>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                        ...
                                                        <div>
                                                            <div style="font-family: inherit; text-align: center"><a
                                                                    href="{{route('shop')}}"><span
                                                                        style="color: #ffffff">Shop</span></a></div>
                                                            <div></div>
                                                        </div>
                                                    </td>
                                                </tr>
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td style="padding:18px 0px 18px 0px; line-height:22px; text-align:inherit;"
                                                        ...
                                                        <div>
                                                            <div style="font-family: inherit; text-align: center"><a
                                                                    href="{{route('track-your-order')}}"><span
                                                                        style="color: #ffffff">Track your order</span></a></div>
                                                            <div></div>
                                                        </div>
                                                    </td>
                                                </tr>
        ...
        <div data-role="module-unsubscribe" class="module" role="module" data-type="unsubscribe"
            ...
            <div class="Unsubscribe--addressLine">
                <p class="Unsubscribe--senderName" style="font-size:12px; line-height:20px;">{{$order->billing_name}}</p>
                <p style="font-size:12px; line-height:20px;"><span
                        class="Unsubscribe--senderAddress">{{$order->billing_address}}</span>, <span
                        class="Unsubscribe--senderCity">{{$order->billing_city}}</span>, <span
                        class="Unsubscribe--senderState">{{$order->billing_state}}</span> <span
                        class="Unsubscribe--senderZip">{{$order->billing_zip}}</span></p>
            </div>
        </div>
        </td>
        </tr>
