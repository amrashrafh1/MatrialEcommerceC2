        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12" id="create-payment">
                    ...
                    {!!
                    Form::open(['url'=>route('payments.update', $rows->id),'id'=>'users','class'=>'form-horizontal
                    form-row-seperated','method'=>'put',]) !!}
                    <br/>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                        <input type="text" name="payment" class="form-control" placeholder="payment" value='{{$rows->payment}}' >
                        </div>
                    </div>
                    <br />
                    <div class="form-group row" style="height: 150px;">
                        ...
                        <div class="col-md-10">
                            {!!
                            Form::select('countries[]',\App\Country::pluck('country_name','id'), old('countries', $rows->countries),['multiple'=>'multiple','class'=>'form-control', 'style'=> 'height:auto'])
                            !!}
                        </div>
                    </div>
                    <br>
