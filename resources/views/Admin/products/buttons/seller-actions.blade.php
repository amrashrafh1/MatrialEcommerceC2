    ...
    <div class="btn-group">
        ...
        <div class="mr-3">
            <li class="list-unstyled">
                <a href="{{ route('seller_frontend_products_variations', $slug)}}" class="btn btn-primary"><i
        ...
        <div class="mr-3">
            <li class="list-unstyled">
                <a href="{{ route('seller_frontend_products_accessories', $slug)}}" class="btn btn-primary"><i
                        class="fe fe-plus"></i> {{trans('admin.add_accessories')}}</a>
            </li>
        </div>
        @endif
        ...
        <div class="mr-3">
            <li class="list-unstyled">
                <a href="{{route('seller_add_discount',$id)}}" class="btn btn-success"><i class="fe fe-plus"></i>
                    {{trans('user.add_discount')}}</a>
            </li>
        </div>
        <div class="pull-right" style="
            ...
            ">
            <a class="btn btn-default btn-outlines btn-circle" style="color: #fff !important;" href="javascript:;"
            ...
            <ul class="dropdown-menu pull-right p-2">
                <li class='padding:10px;'>
                    <a href="{{ route('seller_frontend_products_edit', $slug)}}"><i class="fe fe-edit"></i>
                        {{trans('admin.edit')}}</a>
                </li>
                <li class="divider"> </li>
                <li>
