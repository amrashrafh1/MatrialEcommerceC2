				...
				<div class="btn-group">
                    ...
                    <div class="mr-3">
                        <li class="list-unstyled">
                            <a href="{{ route('product_variations', $id)}}" class="btn btn-primary btn-sm"><i class="fe fe-plus"></i> {{trans('admin.Variations')}}</a>
                        </li>
                    </div>
                    @endif
                    ...
                    <div class="mr-3">
                        <li class="list-unstyled">
                            <a href="{{ route('add_accessories', $id)}}" class="btn  btn-primary btn-sm"><i class="fe fe-plus"></i> {{trans('admin.accessories')}}</a>
                        </li>
                    </div>
                    @endif
                    <div class="pull-right">
						<a class="btn btn-default btn-outlines btn-circle btn-sm" href="javascript:;" data-toggle="dropdown" data-hover="dropdown" data-close-others="true" aria-expanded="false">
