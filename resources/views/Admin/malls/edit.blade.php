        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    ...
                    {!! Form::open(['url'=>route('malls.update',$rows->id),'method' => 'patch','id'=>'users','files'=>true,'class'=>'form-horizontal
                    form-row-seperated']) !!}
                     @foreach(LaravelLocalization::getSupportedLocales() as $localeCode => $properties)
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {!!
                                Form::text('name_'.$localeCode,\App\Mall::where('id', $rows->id)->first()->getTranslation('name', $localeCode),['class'=>'form-control
