        ...
        <div class="widget-extra body-req portlet light bordered">
            <div class="portlet-title">
                ...
                <div class="actions">
                    <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('/admins/create')}}"
                        data-toggle="tooltip" title="{{trans('admin.manufacturers')}}">
                        <i class="fa fa-plus"></i>
                    </a>


                    <span data-toggle="tooltip" title="{{trans('admin.delete')}}  {{trans('admin.manufacturers')}}">
                    ...
                    <a class="btn btn-circle btn-icon-only btn-default" href="{{aurl('/admins')}}" data-toggle="tooltip"
                        title="{{trans('admin.show_all')}}   {{trans('admin.manufacturers')}}">
            ...
            <div class="portlet-body form">
                ...
                <div class="card-body text-center cover-image" data-image-src="{{url('/')}}/Backend/assets/img/profile-bg.jpg">
                        ...
                        <h3 class="mt-3 text-white">{{$rows->name}}</h3>
                        <p class="mb-4 text-white">
                            @foreach($rows->roles as $role)
                                {{$role->display_name}}
                            @endforeach
                        </p>
                        <a href="{{route('admins.edit', $rows->id)}}" class="btn btn-success btn-sm"><i class="fas fa-pencil-alt" aria-hidden="true"></i>
                            Edit profile</a>
                    </div>
                </div>
