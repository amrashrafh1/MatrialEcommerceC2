<div class="actions">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
            <li>
                <a href="{{ route('malls.edit', $id)}}"><i class="fe fe-edit"></i> {{trans('admin.edit')}}</a>
            </li>
            <li class="divider"> </li>
            <li>
                <a href="{{ route('malls.show', $id)}}"><i class="fa fa-eye"></i> {{trans('admin.show')}}</a>
            </li>
            <li>
