@extends('Admin.layouts.app', ['activePage' => 'manufacturers-management', 'titlePage' => trans('admin.manufacturers')])
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="widget-extra body-req card light bordered">
            <div class="card-header">
                ...
                <div class="actions">
                    <a href="{{aurl('/manufacturers')}}" class="btn btn-circle btn-icon-only btn-default"
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    ...
                    {!! Form::open(['url'=>route('manufacturers.store'),'id'=>'users','files'=>true,'class'=>'form-horizontal
                    form-row-seperated']) !!}
                    <div class="col-md-12">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                {!!
                                Form::text('name_'.$localeCode,old('name'),['class'=>'form-control
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!!
                                Form::text('email',old('email'),['class'=>'form-control','placeholder'=>trans('admin.email')])
                                !!}
                            </div>
                        </div>
                        <br>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!!
                                Form::text('facebook',old('facebook'),['class'=>'form-control','placeholder'=>trans('admin.facebook')])
                                !!}
                            </div>
                        </div>
                        <br>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!!
                                Form::text('twitter',old('twitter'),['class'=>'form-control','placeholder'=>trans('admin.twitter')])
                                !!}
                            </div>
                        </div>
                        <br>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!!
                                Form::text('website',old('website'),['class'=>'form-control','placeholder'=>trans('admin.website')])
                                !!}
                            </div>
                        </div>
                        <br>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                {!!
                                Form::text('mobile',old('mobile'),['class'=>'form-control','placeholder'=>'+1 (769) 458-7246'])
                                !!}
                            </div>
                        </div>
                        <br>
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                            {!! Form::text('address',old('address'),['class'=>'form-control','id' =>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-10">
                                ...
                                'id'),null,['class'=>'form-control','placeholder'=>trans('admin.Country')])
                                !!}
                            </div>
                        </div>
                        <br>
