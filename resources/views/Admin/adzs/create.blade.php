@extends('Admin.layouts.app', ['activePage' => 'adzs-management', 'titlePage' => trans('admin.adzs')])
@section('content')
        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    ...
                    {!!
                    Form::open(['url'=>route('adzs.store'),'id'=>'users','files'=>true,'class'=>'form-horizontal
