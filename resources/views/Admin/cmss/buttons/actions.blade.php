@if($type == 'products')
<div class="actions">
    <a class="btn btn-default btn-primary btn-circle" href="{{route('cmss_create_products', $id)}}"
        >
...
<div class="actions">
    <div class="btn-group">
        ...
        <ul class="dropdown-menu pull-right">
            <li class="divider"> </li>
            <li>
                <a href="{{ route('cmss.edit', $id)}}"><i class="fa fa-edit"></i> {{trans('admin.edit')}}</a>
            </li>
            <li>
