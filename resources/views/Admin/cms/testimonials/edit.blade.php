@extends('Admin.layouts.app', ['activePage' => 'testimonials-management', 'titlePage' => trans('admin.countries')])
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    {!!
                    Form::open(['url'=>route('testimonials.update', $rows->id),'method' => 'PUT','id'=>'users','files'=>true,'class'=>'form-horizontal
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {!!
                            Form::text('project_type',old('project_type', $rows->project_type),['class'=>'form-control','placeholder'=>trans('admin.project_type')])
                            !!}
                        </div>
                    </div>
                    <br>
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            {!!
                            Form::text('comment',old('comment', $rows->comment),['class'=>'form-control','placeholder'=>trans('admin.comment')])
                            !!}
                        </div>
                    </div>
                    <br>
