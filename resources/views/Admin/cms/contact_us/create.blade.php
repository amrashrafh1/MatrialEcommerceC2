@extends('Admin.layouts.app', ['activePage' => 'contact_us-management', 'titlePage' => trans('admin.contact_us')])
@section('content')
        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    ...
                    {!!
                    Form::open(['url'=>route('contact_us.store'),'id'=>'users','files'=>true,'class'=>'form-horizontal
