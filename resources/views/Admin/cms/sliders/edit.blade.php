@extends('Admin.layouts.app', ['activePage' => 'sliders-management', 'titlePage' => trans('admin.countries')])
@section('content')
    ...
    <div class="col-md-12">
        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    {!!
                    Form::open(['url'=>route('sliders.update', $rows->id),'method' => 'PUT','id'=>'users','files'=>true,'class'=>'form-horizontal
