    ...
    <div class="col-md-12">
        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    {!!
                    Form::open(['url'=>route('ourworks.update', $rows->id),'method' => 'PUT','id'=>'users','files'=>true,'class'=>'form-horizontal
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-md-10">
                            <input type="text" name="link" value='{{$rows->link}}' class='form-control'
