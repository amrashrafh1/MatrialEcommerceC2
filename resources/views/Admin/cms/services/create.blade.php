@extends('Admin.layouts.app', ['activePage' => 'services-management', 'titlePage' => trans('admin.services')])
@section('content')
        ...
        <div class="widget-extra body-req card light bordered">
            ...
            <div class="card-body form">
                <div class="col-md-12">
                    ...
                    {!!
                    Form::open(['url'=>route('services.store'),'id'=>'users','files'=>true,'class'=>'form-horizontal
