						...
						<div class="card light bordered">
								...
								<div class="card-body col-md-12">
                                    <div class="table-responsive">
										{!! Form::open([
										"method" => "post",
                                        "url" => [route('shippingcompanies_destroy_all')],
                                        'id' => 'form_data'
										]) !!}
										{!! $dataTable->table(["class"=> "table table-striped table-bordered table-hover table-checkable dataTable no-footer w-100"],true) !!}
