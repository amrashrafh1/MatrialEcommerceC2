            ...
            order: 2;">
                ...
                <div class="widget-extra body-req card light bordered">
                    ...
                    <div class="card-body form">
                        <div class="col-md-12">
                            {!!
                            Form::open(['url'=>route('seller_discount_store',$id),'id'=>'users','class'=>'form-horizontal
                            form-row-seperated']) !!}
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!!
                                    Form::datetimeLocal('start_at',old('start_at'),['class'=>'form-control
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-9">
                                    {!!
                                    Form::datetimeLocal('expire_at',old('expire_at'),['class'=>'form-control
                            ...
                            <br>
                            <div id='product_y'>
                                @livewire('admin.discount.product-id', ['type'=>'product_y', 'owner' => 'for_seller'])
                            </div>
                            <br>
