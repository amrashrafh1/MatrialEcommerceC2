        ...
        <div class="row">
            ...
            <div id="primary" class="content-area">
                <main id="main" class="site-main">
                    ...
                    <section class="section-products-carousel new-arrival-carousel" id="section-products-carousel-7" wire:ignore>
                        <header class="section-header">
                                    ...
                                    <div class="products">
                                        ...
                                        <div class="product">
                                            ...
                                            <a href="{{route('show_product',$product->slug)}}"
                                                ...
                                                <span
                                                    class='product_shipping'>@lang('user.Sold'): {{($product->sold)?$product->sold:0}}</span>
