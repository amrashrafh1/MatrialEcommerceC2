                    ...
                    <div class="shop-archive-header" wire:ignore>
                        <div class="jumbotron">
                            <div class="jumbotron-img">
                                <img width="416" height="283" alt="" src="{{Storage::url($this->brand->logo)}}"
                                    class="jumbo-image alignright">
                            </div>
                            <div class="jumbotron-caption">
                                <h3 class="jumbo-title">{{$this->brand->name}}</h3>
                            </div>
                            <!-- .jumbotron-caption -->
                        </div>
                        <!-- .jumbotron -->
                    ...
                    <ul class="show-all-cat">
                        <li class="product_cat">
                            ...
                            <ul>
                                ...
                                <li class="cat-item"><a
                                        href="{{route('show_category',$category->slug)}}">{{$category->name}}</a></li>
                                @endforeach
                            </ul>
                        </li>
                    </ul>
